...
INSTALLED_APPS = [
    ...
    'dashboard',  # Our weather dashboard app
]
...
# ============================================================================
# Security Settings for Weather Dashboard
# ============================================================================

# API Timeout settings
API_REQUEST_TIMEOUT = 5  # seconds

# CORS Settings (if needed for frontend-backend separation)
# Install: pip install django-cors-headers
# Uncomment if using separate frontend domain
# CORS_ALLOWED_ORIGINS = [
#     "http://localhost:3000",
#     "http://127.0.0.1:3000",
# ]

# CSRF Settings - ensure frontend includes CSRF token in AJAX requests
